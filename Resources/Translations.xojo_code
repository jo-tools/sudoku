...
Protected Module Translations
	#tag Constant, Name = kButtonCancel, Type = String, Dynamic = True, Default = \"Cance&l", Scope = Public
	...
	#tag Constant, Name = kDifficultyMedium, Type = String, Dynamic = True, Default = \"Medium", Scope = Public
		#Tag Instance, Platform = Any, Language = de, Definition  = \"Mittel"
		#Tag Instance, Platform = Any, Language = fr, Definition  = \"Moyen"
		#Tag Instance, Platform = Any, Language = es, Definition  = \"Medio"
	#tag EndConstant

	#tag Constant, Name = kDifficultyMediumEasy, Type = String, Dynamic = True, Default = \"Medium easy", Scope = Public
		#Tag Instance, Platform = Any, Language = de, Definition  = \"Mittel leicht"
		#Tag Instance, Platform = Any, Language = fr, Definition  = \"Moyennement facile"
	...
	#tag Constant, Name = kLabelSudokuSizeN, Type = String, Dynamic = True, Default = \"Size", Scope = Public
		#Tag Instance, Platform = Any, Language = de, Definition  = \"Gr\xC3\xB6sse"
		#Tag Instance, Platform = Any, Language = fr, Definition  = \"Taille"
		#Tag Instance, Platform = Any, Language = es, Definition  = \"Tama\xC3\xB1o"
	#tag EndConstant
