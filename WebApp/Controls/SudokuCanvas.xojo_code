...
Inherits WebSDKUIControl
	...
	#tag Method, Flags = &h21
		Private Function ColorToRGBA(c As Color) As String
		  ...
		  Return "rgba(" + c.Red.ToString + "," + c.Green.ToString + "," + c.Blue.ToString + "," + alpha.ToString(Nil, "0.00") + ")"
		End Function
	#tag EndMethod
