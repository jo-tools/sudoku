...
Begin WebContainer DownloadChoice
   Compatibility   =   ""
   ControlCount    =   0
   ControlID       =   ""
   CSSClasses      =   ""
   ...
   Begin WebLabel labSeparator
      ...
      _mPanelIndex    =   -1
   End
   Begin WebLink labSudokuDesktop
      Appearance      =   0
      Bold            =   True
      ControlID       =   ""
      CSSClasses      =   ""
